...
Аналогично, используя выражения \eqref{u_cherez_L_M}, \eqref{tenzor_napr} запишем граничные условия \eqref{vnutr_pover_sloja} через функции ${u\l}_\r,$ ${u\l}_\f,$ ${u\l}_z,$ $ \P\cyl,$ $L$ и $M ,$ а граничные условия \eqref{gran_pol} через $\P\cyl,$ $ \P\c,$ $L$ и $M.$
\begin{align}
\begin{split}
...
\begin{align}
\begin{split}
&\mu\l\Biggl(\frac{1}{\r\l}\frac{\partial {u\l}_{\r}}{\partial\f\l}+\frac{\partial {u\l}_{\f}}{\partial \r\l}-\frac{{u\l}_{\f}}{\r\l}\Biggr)=\frac{\mu\cyl}{\r^2\cyl}\Biggl(2\r\cyl\frac{\partial^2\Psi\cyl}{\partial\r\cyl\partial\f\cyl}+\r\cyl\frac{\partial^3 L}{\partial\r\cyl\partial\f\cyl\partial z\cyl}+\\
...
\end{split}\\
\begin{split}
&\mu\l\Biggl(\frac{\partial {u\l}_z}{\partial \r\l}+\frac{\partial {u\l}_{\r}}{\partial z\l}\Biggr)=\mu\cyl\Biggl(2\frac{\partial^2\Psi\cyl}{\partial\r\cyl\partial z\cyl}-\frac{\partial^3 L}{\partial\r^3\cyl}+\frac1{\r^2\cyl}\frac{\partial L}{\partial\r\cyl}-\frac1{\r\cyl}\frac{\partial^2 L}{\partial\r^2\cyl}+\\
...
Граничные условия \eqref{gran_pol} примут вид:
\begin{align}
\begin{split}
...
Подставив разложения \eqref{razloj_u} в уравнения \eqref{equation_otn_u}, сократив на $\exp\{i\alpha z\cyl\},$ получим
...
\newpage
Подставив разложения \eqref{razloj_psi_o}, \eqref{razloj_psi_s} и \eqref{razloj_u} в уравнения \todo{правильно сделать ссылку} получим
\begin{align}\label{gran_usl_1_with_summ}
&\sum\limits_{n=-\infty}^{\infty}A_0i^nJ_n(\beta\en  \r\cyl)\exp\{in(\f\cyl-\hat\f\en)\}+\\
&+A_nH_n(\beta\cyl \r\cyl)\exp\{in\f\cyl\}=-iw\sum_{n=-\infty}^{\infty}{u\l}_{\r\:n}(\r\cyl)\exp\{in\f\cyl\},\\
&\lambda\l\Biggl(\frac{\partial {u\l}_{\r}}{\partial \r\l}+\frac{1}{\r\l}\biggl(\frac{\partial {u\l}_\f}{\partial\f\l}+{u\l}_{\r}\biggr)+\frac{\partial {u\l}_z}{\partial z\l}\Biggr)+2\:\mu\l\:\frac{\partial {u\l}_{\r}}{\partial \r\l}=-iwp\en(\Psi_{o}+\Psi_s),\\
&\mu\l\Biggl(\frac{1}{\r\l}\frac{\partial {u\l}_{\r}}{\partial\f\l}+\frac{\partial {u\l}_{\f}}{\partial \r\l}-\frac{{u\l}_{\f}}{\r\l}\Biggr)=0,\\
&\mu\l\Biggl(\frac{\partial {u\l}_z}{\partial \r\l}+\frac{\partial {u\l}_{\r}}{\partial z\l}\Biggr)=0.\\
 \end{align}
