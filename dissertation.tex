...
Функции $u_\r(\r, \f, z),$ $u_\f(\r, \f, z)$ и $u_z(\r, \f, z)$ будем искать в виде
\begin{equation}
\begin{aligned}
...
Коэффициенты $A_n,$ $B_n,$ $C_n,$ $D_n,$ $E_n$ разложений \todo{ССЫЛКИ!!!!} и функции $u_{\r n}(\r),$ $u_{\f n}(\r)$ и $u_{z n}(\r)$ из разложений \todo{ССЫЛКИ} подлежат определению из граничных условий.
...
Используя формулы
$$v_n=\frac{\d(\Psi_0+\Psi_s)}{\d\r}, \:\:\: P=-i(\Psi_0+\Psi_s)$$
и выражения \todo{ССЫЛКА}, запишем граничные условия \todo{ССЫЛКА} через функции. Получим при 
\newpage
