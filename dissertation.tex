...
\todo{Исправить фразу}
Аналогично, используя выражения \eqref{u_cherez_L_M}, \eqref{tenzor_napr} запишем граничные условия \eqref{vnutr_pover_sloja} через функции ${u\l}_\r,$ ${u\l}_\f,$ ${u\l}_z,$ $ \P\cyl,$ $L$ и $M ,$ а граничные условия \eqref{gran_pol} через $\P\cyl,$ $L$ и $M.$
\todo {Подставить и переписать ${u}\cyl$}
\begin{align}
...
&-2\frac{\partial \Psi\cyl}{\partial\f\cyl}-k\popr \r^2\cyl\frac{\partial^2 M}{\partial\r^2\cyl}+k\popr\r\cyl\frac{\partial M}{\partial\r\cyl}\Biggr),\\
...
&+\frac{\partial^3 L}{\partial\r\cyl\partial z^3\cyl}+k\popr\frac{\partial^2 M}{\partial\f\cyl\partial z\cyl}\Biggr).
\end{align}
...
&\frac1{\r^2\cyl}\Biggl(-\lambda\cyl\frac{\partial^3L}{\partial z\cyl\partial\f^2\cyl}+2\mu\cyl \r^2\cyl\frac{\partial^3L}{\partial z\cyl\partial\r^2\cyl}+2\r\cyl\Biggl(\Biggl[\frac12\r\cyl-\frac12\Biggr]\lambda\cyl+\r\cyl\mu\cyl\Biggr)\cdot\\
&\cdot k\popr\frac{\partial^2M}{\partial \r\cyl\partial\f\cyl}+2\Biggl(\frac12\lambda\cyl+\mu\cyl\Biggr)\r^2\cyl\frac{\partial^2\Psi\cyl}{\partial \r^2\cyl}+\Biggl(\frac{\partial^2\Psi\cyl}{\partial\f^2\cyl}+\\
&\r\cyl\Biggl(\r\cyl\frac{\partial^2\Psi\cyl}{\partial z^2\cyl}+\frac{\partial \Psi\cyl}{\partial \r\cyl}+k\popr\frac{\partial M}{\partial\f\cyl}\Biggr)\Biggr)\lambda\cyl\Biggr)=-iwp\c\Psi\c,\\
&\frac{\mu\cyl}{\r^2\cyl}\Biggl(2\r\cyl\frac{\partial^2\Psi\cyl}{\partial\r\cyl\partial\f\cyl}+\r\cyl\frac{\partial^3 L}{\partial\r\cyl\partial\f\cyl\partial z\cyl}+\r\cyl k\popr\frac{\partial^2 M}{\partial\f^2\cyl}-\\
